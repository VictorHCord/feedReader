    ...
    */
    ...
    describe('RSS Feeds', function() {
        ...
        it('Definindo  URL', function(){
            ...
            * Vai percorrer tanto URL 
            * */
            for(let feed of allFeeds){
                expect(feed.url).toBeDefined(); //Garantindo que o URL esteja definido
                expect(feed.url.length).not.toBe(0); //Garantindo que o URL nao esteja vazio
            };
        });

        it('Definindo NAME', function(){
            for(let feed of allFeeds){
                expect(feed.name).toBeDefined(); //Garantindo que NAME esteja definido
                expect(feed.name.length).not.toBe(0); //Garantindo que NAME nao esteja vazio
            };
        });
    });
